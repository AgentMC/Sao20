...
1. <a name="Prim1"></a>В оригинале, речь про ループ, loop, петля. Асуна приводит альтернативные значения японского rupu, не имеющие отношения как к английскому, так и, в ещё большей степени, к переводу на русский.
